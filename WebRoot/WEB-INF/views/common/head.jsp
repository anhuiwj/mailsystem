...
<!--[if lt IE 9]>
<script type="text/javascript" src="${ctxStatic}/global/plugins/respond.min.js"></script>
<script type="text/javascript" src="${ctxStatic}/global/plugins/excanvas.min.js"></script>
<![endif]-->
...
<script src="${ctxStatic}/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
