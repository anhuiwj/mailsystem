...
<div class="pd-20">
    <div class="cl pd-5 bg-1 bk-gray">
        <div class="j_hform">
            ...
            <p>
				 <span>
	                    <button name="query" id="query" class="btn btn-success radius l" type="submit"
	                            style="margin-left: 30px;">收件
	                    </button>
	               </span>
	               
	               <span>
	                    <button name="add" id="add" class="btn btn-success radius l" type="submit"
	                            style="margin-left: 30px;">新建邮件
	                    </button>
	               </span>
            </p>
            <p>
    ...
    <div class="tbl_header mt-20">
        <strong>收件箱</strong><p class="tbl_header_r">
...
<script>
    $(function () {
        ...
        var dtList = function () {
            var columns = [
                {id: 'sendUser', title: '发送人', type: 'string', columnClass: 'text-c td'},
                {id: 'title', title: '邮件标题', type: 'string', columnClass: 'text-c'},
                {id: 'isRead', title: '是否已读', type: 'string', columnClass: 'text-c',
                    resolution:function(value, record, column, grid, dataNo, columnNo){
                    var content = '';
                           if($.trim(value)=='1'){
                        	   content += '<span>已读</span>';
                               }else{
                            	   content += '<span>未读</span>';
                                   }
                        return content;
                	}
                 },
                {id: 'id', title: '操作', type: 'string',codeTable:whether, columnClass: 'text-c',
                    ...
                    var content = '';
                            ...
                            content += '&nbsp<input onclick="deleteAll(\''+record.id+'\');" value="彻底删除" class="btn btn-primary size-MINI radius" type="button">';
                        return content;
                    }
                }
            ];
