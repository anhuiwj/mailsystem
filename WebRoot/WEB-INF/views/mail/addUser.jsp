...
<body>
<div class="pd-20">
    <form action="${ctx}/tongxun/save" method="post" class="form form-horizontal va-m" id="form-role-edit">
        <input class="input-text hidden" name="id" value="${user.id}" style="width:300px;" display="none">
        <div class="f-l w-980 mb-20">
            <label class="f-l mr-30 w-200">姓名</label>
            <input class="input-text" name="userName" value="${user.userName}" style="width:300px;">
        </div>
            <div class="f-l w-980 mb-20">
                <label class="f-l mr-30 w-200">邮箱地址</label>
                <input class="input-text" name="email"  value="${user.email}" datatype="e" style="width:300px;">
            </div>
